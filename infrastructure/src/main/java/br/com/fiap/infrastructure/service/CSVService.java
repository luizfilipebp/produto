...
public class CSVService {
    ...
    public CSVService(@Value("${file.upload-dir}") String fileStorageLocation,
                      @Qualifier("jobLauncherAsync") JobLauncher jobLauncher, Job job) {
        this.fileStorageLocation = Paths.get(System.getProperty("user.dir") + "/infrastructure", fileStorageLocation).toAbsolutePath().normalize();
